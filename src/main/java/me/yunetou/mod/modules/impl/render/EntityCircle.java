...
public class EntityCircle
    ...
    public final Setting<Boolean> crystal = this.add(new Setting<>("Crystal", true));
    ...
    public EntityCircle() {
        super("EntityCircle", "jello", Category.RENDER);
        this.width = this.add(new Setting<>("Width", 1.0, 0.1, 7.0, this::new0));
        this.height = this.add(new Setting<>("Height", 2.0, 0.1, 7.0, this::new1));
        this.player = this.add(new Setting<>("Player", true));
        this.animals = this.add(new Setting<>("Animals", false));
    ...
    public void onRender3D(Render3DEvent render3DEvent) {
        for (Entity entity : EntityCircle.mc.world.loadedEntityList) {
            ...
            for (int i = 0; i < 360; i += 5) {
                Color color = YuneTou.colorManager.getRainbow();
