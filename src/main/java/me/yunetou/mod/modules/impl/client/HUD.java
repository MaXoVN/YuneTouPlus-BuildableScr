...
public class HUD extends Module {
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        if (watermark.getValue()) {
            ...
            String verString = verColor + (watermarkShort.getValue() ? YuneTou.MODVER.substring(0, 4) : YuneTou.MODVER + "+" + YuneTou.VERHASH);
    ...
    private void drawPvPInfo() {
        ...
        String plrColor = String.valueOf(
                (target != null && mc.player.getDistance(target) <= 5)
                        ? ChatFormatting.GREEN
                        : ChatFormatting.DARK_RED);
