...
public class PortalESP
    ...
    private void drawBlock(BlockPos pos) {
        ...
        if (this.outline.getValue()) {
            RenderUtil3.drawBBBox(axisAlignedBB, this.color.getValue(), this.outlineAlpha.getValue());
        }
        if (this.box.getValue()) {
            RenderUtil3.drawBoxESP(pos, this.color.getValue(), this.boxAlpha.getValue());
        }
    }
