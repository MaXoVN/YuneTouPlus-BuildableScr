    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtil.drawRect(
                ...
                dotgod
                        ...
                        ? Managers.COLORS.getCurrentWithAlpha(65)
                        : Managers.COLORS.getCurrentWithAlpha(90))
                        : (!this.isHovering(mouseX, mouseY)
                        ? Managers.COLORS.getCurrentWithAlpha(26)
                        : Managers.COLORS.getCurrentWithAlpha(55)))
                        : (this.setting.hasBoolean
                        ? (this.setting.booleanValue
                        ? (!this.isHovering(mouseX, mouseY)
                        ? Managers.COLORS.getCurrentWithAlpha(120)
                        : Managers.COLORS.getCurrentWithAlpha(200))
                        : (!this.isHovering(mouseX, mouseY)
                        ? 0x11555555
                        : -2007673515))
                        : (!this.isHovering(mouseX, mouseY)
        ...
        if (this.setting.open) {
            ...
            Managers.TEXT.drawStringWithShadow(
                    ...
                    this.x + 2.3f,
                    this.y + 113.0f,
                    this.isInsideCopy(mouseX, mouseY) ? -1 : -5592406
            );
            Managers.TEXT.drawStringWithShadow(
                    "paste",
