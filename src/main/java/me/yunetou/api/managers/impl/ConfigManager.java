...
import me.yunetou.mod.modules.settings.EnumConverter;
...
implements Wrapper {
    ...
    public static void setValueFromJson(Mod mod, Setting setting, JsonElement element) {
        ...
        YuneTou.LOGGER.error("Unknown Setting type for: " + mod.getName() + " : " + setting.getName());
    }
    ...
    public void init() {
        ...
        YuneTou.LOGGER.info("Config loaded.");
    }
    ...
    private void loadPath(Path path, Mod mod) throws IOException {
        ...
        try {
            ...
            YuneTou.LOGGER.error("Bad Config File for: " + mod.getName() + ". Resetting...");
